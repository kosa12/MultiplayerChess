...
import client.gui.Table.MoveLog;
...
class TakenPiecesPanel extends JPanel {
    ...
    private static final Dimension TAKEN_PIECES_PANEL_DIMENSION = new Dimension(50, 400);
    ...
    public void redo(final MoveLog moveLog) {
        ...
        for (final Piece takenPiece : whiteTakenPieces) {
            try {
                final BufferedImage image = ImageIO.read(new File("src/client/gui/chessPiece/"
                ...
                final JLabel imageLabel = new JLabel(new ImageIcon(ic.getImage().getScaledInstance(
                        ic.getIconWidth() - 35, ic.getIconWidth() - 35, Image.SCALE_SMOOTH)));
